...
import logosIcon from "../assets/logo craving.png";
...
const FooterSection = () => {
  return (
    <footer className="flex flex-col justify-around flex-wrap gap-16 py-10 bg-black bg-[black]">
        ...
        <div className="flex justify-center gap-32 flex-wrap ">
          ...
          <div className="text-white">
            ...
            <div className="text-[16.1px] mt-6 flex flex-col justify-center gap-4">
              ...
              <span>
                <p>
                  <EmailIcon style={{ color: "#FF9800" }} /> cravings@gmail.com
                </p>
              </span>
              <span>
                <p>
                  <CallIcon style={{ color: "#FF9800" }} /> +91 5234 568 254
                </p>
              </span>
            </div>
          </div>
